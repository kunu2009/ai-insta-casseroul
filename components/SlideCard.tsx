...
const SlideCard: React.FC<SlideCardProps> = ({ slide, index, onImageUpload }) => {
  ...
  return (
    <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-4 flex flex-col h-full overflow-hidden">
      ...
      <button 
        ...
        className="w-full mt-4 flex items-center justify-center gap-2 px-4 py-2 bg-gray-700/50 text-gray-300 font-semibold rounded-lg hover:bg-gray-700 transition-colors duration-200 text-sm"
      >
