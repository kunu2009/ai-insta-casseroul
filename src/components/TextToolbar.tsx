...
import { BoldIcon, ItalicIcon, UnderlineIcon, AlignLeftIcon, AlignCenterIcon, AlignRightIcon, TextSizeIcon, PaletteIcon, StrikethroughIcon, TextShadowIcon, TextOutlineIcon } from './icons';
